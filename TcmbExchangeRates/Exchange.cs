...
namespace TcmbExchangeRates
{
    public class Exchange
    {
        ...
        static string ExchangeUrl = @"https://www.tcmb.gov.tr/kurlar/today.xml";
        public static Dictionary<string, Currency> GetAllCurrenciesTodaysExchangeRates()
        {
            try
            {
                return GetCurrencyRates(ExchangeUrl);
            }
            catch (Exception ex)
            {
        ...
        public static DataTable GetDataTableAllCurrenciesTodaysExchangeRates()
        {
            try
            {
                Dictionary<string, Currency> CurrencyRates = GetCurrencyRates(ExchangeUrl);
