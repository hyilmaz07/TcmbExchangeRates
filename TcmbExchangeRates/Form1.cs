    ...
    public partial class Form1 : Form
    {
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    con.ConnectionString = $@"Server={txtServer.Text};Database={txtDatabase.Text};User ID={txtUser.Text};Password={txtPass.Text};Trusted_Connection=False;";
                    con.Open();
                }
        ...
        {
            dataGridView1.DataSource = Exchange.GetDataTableAllCurrenciesHistoricalExchangeRates(dateTimePicker1.Value);
        }
